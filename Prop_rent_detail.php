...
<body>
    ...
    <center>
        <h1 class="my-2 text-decoration-underline">Add Property on Rent</h1>
    </center>

    <div class="container my-3">
        <center>
            <div class="add">
                <form action="addproprentform.php" method="post" enctype="multipart/form-data">
                    <div class="name">
                        <label for="name">Tenant name:</label><br>
                    ...
                    <div class="price">
                        <label for="price">House Rent(PKR):</label><br>
