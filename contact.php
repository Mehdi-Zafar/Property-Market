...
<body>
    ...
    <main>
        <div class="container w-50 text-center mt-5 rounded-5 shadow-lg p-4" style="background-color: #FFFFDC;">
            <h1 class="p-1">Contact Info</h1>
            <h2 class="p-1"><b><i class="bi bi-telephone-fill"></i> Contact Number:</b></h2>
            <h3><a class="text-dark text-decoration-none" href="tel:35894033">35894033</a></h3>
            <h2 class="p-1"><b><i class="bi bi-envelope-fill"></i> Email Address:</b> </h2>
            <h3><a class="text-dark text-decoration-none" href="mailto:PropertyRent987@gmail.com">PropertyRent987@gmail.com</a></h3>
            <h2 class="p-1"><b><i class="bi bi-building"></i> Office Address:</b></h2>
            <h3>D-7, Convention Road, Clifton, Karachi</h3>
        </div>
    </main>
